...
Main:CreateButton("Snitch Check", "Activate", function()
                   local Rats = {"Vexzerk" ,"gordon_freeman4444","hendriexx", "adrin761" ,"joejerry44", "Populacho", "darkwheaten", "angelo1357", "legozgh", "Onzixy", "ItxWolfie", "MyLordZer0", "KazaTheGreat", "iSpectate_WasTaken", "TheSplxsh", "kingunthere2000", "nawfal_hali", "dominickYT2", "The2334pk", "Nxrutt", "ObamaSunShine", "KrubiCX", "angjunxian_gamingyo", "Jonathanisrocking", "OhMyGoshDaMan", "MadSacha"}
...
game:GetService("Players").LocalPlayer.Character[tool].ammo:GetPropertyChangedSignal("Value"):Connect(function()
    ...
    game:GetService("Players").LocalPlayer.Character[tool].ammo.Value = max
        ...
        Car:CreateButton("Rapid Fire Gun [Hold]", "Mod", function()
                                                -- Generated by Hydroxide's Upvalue Scanner: https://github.com/Upbolt/Hydroxide

local aux = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/vertigoc/cool/main/Utilty/HydroxideAux.lua"))()
...
local elementIndex = "rpm"
                ...
                Car:CreateButton("Automatic Gun [Hold]", "Mod", function()
