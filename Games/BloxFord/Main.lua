...
Main:CreateButton("Snitch Check", "Activate", function()
                   local Rats = {"hendriexx","Vexzerk" ,"gordon_freeman4444","hendriexx", "adrin761" ,"joejerry44", "Populacho", "darkwheaten", "angelo1357", "legozgh", "Onzixy", "ItxWolfie", "MyLordZer0", "KazaTheGreat", "iSpectate_WasTaken", "TheSplxsh", "kingunthere2000", "nawfal_hali", "dominickYT2", "The2334pk", "Nxrutt", "ObamaSunShine", "KrubiCX", "angjunxian_gamingyo", "Jonathanisrocking", "OhMyGoshDaMan", "MadSacha"}
