...
Main:CreateButton("Snitch Check", "Activate", function()
                   local Rats = {"InfiniteStella","satanary726","LOYBreezy","AwareDragonBanana","XxfivekillerxX","Eltraxi","PanltMan00","hendriexx","Vexzerk" ,"gordon_freeman4444","hendriexx", "adrin761" ,"joejerry44", "Populacho", "darkwheaten", "angelo1357", "legozgh", "Onzixy", "ItxWolfie", "MyLordZer0", "KazaTheGreat", "iSpectate_WasTaken", "TheSplxsh", "kingunthere2000", "nawfal_hali", "dominickYT2", "The2334pk", "Nxrutt", "ObamaSunShine", "KrubiCX", "angjunxian_gamingyo", "Jonathanisrocking", "OhMyGoshDaMan", "MadSacha"}
...
Generate()
    ...
    Car:CreateButton("Inf Ammo Gun [Hold]", "Mod", function()
       local tool;
...
game:GetService("Players").LocalPlayer.Character[tool].ammo:GetPropertyChangedSignal("Value"):Connect(function()
    ...
    game:GetService("Players").LocalPlayer.Character[tool].ammo.Value = max
        ...
        Car:CreateButton("Auto Gun", "Mod", function()
...
local scriptPath = workspace[plr].gun
...
print("auto")  
                ...
                Car:CreateButton("Faster Gun", "Mod", function()
                        -- Generated by Hydroxide's Upvalue Scanner: https://github.com/Upbolt/Hydroxide
